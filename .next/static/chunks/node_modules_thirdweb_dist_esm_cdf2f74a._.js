...
async function unlinkAccount({ client, ecosystem, profileToUnlink, storage }) {
    ...
    const linkedDetailsResp = await clientFetch(`${IN_APP_URL}/api/2024-05-05/account/disconnect`, {
        method: "POST",
        headers,
        body: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stringify"])(profileToUnlink)
    });
    if (!linkedDetailsResp.ok) {
        const body = await linkedDetailsResp.json();
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_cdf2f74a._.js.map
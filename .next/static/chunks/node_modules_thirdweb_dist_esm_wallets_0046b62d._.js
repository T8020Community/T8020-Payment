...
async function getCoinbaseWebProvider(options) {
    if (!_provider) {
        let CoinbaseWalletSDK = (await __turbopack_context__.r("[project]/node_modules/thirdweb/node_modules/@coinbase/wallet-sdk/dist/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
        ...
        const client = new CoinbaseWalletSDK({
            appName: options?.appMetadata?.name || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$utils$2f$defaultDappMetadata$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultAppMetadata"])().name,
            appChainIds: options?.chains ? options.chains.map((c)=>c.id) : undefined,
            appLogoUrl: options?.appMetadata?.logoUrl || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$utils$2f$defaultDappMetadata$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDefaultAppMetadata"])().logoUrl
        });
...
function createAccount({ provider, address, client }) {
    const account = {
        ...
        async signMessage ({ message }) {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validate"])(res)) {
        ...
        async signTypedData (typedData) {
            ...
            const stringifiedData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$TypedData$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["serialize"])({
                domain: domain ?? {},
                message,
                primaryType,
                types
...
async function getEcosystemInfo(walletId) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$promise$2f$withCache$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withCache"])(async ()=>{
        const res = await fetch(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebBaseUrl"])("inAppWallet")}/api/2024-05-05/ecosystem-wallet`, {
            headers: {
        ...
        autoConnect: async (options)=>{
            ...
            if (ecosystem) {
                ...
                if (smartAccountOptions) {
                    ...
                    const preferredChain = options.chain ?? (defaultChainId ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCachedChain"])(defaultChainId) : undefined);
                    if (!preferredChain) {
    ...
    const account = {
        ...
        async sendTransaction (tx) {
            const gasFees = tx.gasPrice ? {
                gasPrice: tx.gasPrice ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["numberToHex"])(tx.gasPrice) : undefined
            } : {
...
const autoConnectCore = async ({ storage, props, createWalletFn, manager, connectOverride, getInstalledWallets, setLastAuthProvider })=>{
    ...
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$in$2d$app$2f$web$2f$lib$2f$get$2d$url$2d$token$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUrlToken"])();
...
async function getWalletInfo(id, image) {
    ...
    switch(id){
        ...
        case "com.blockchain":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/com.blockchain/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/com.blockchain/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
        ...
        case "one.metapro.wallet":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/one.metapro.wallet/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/one.metapro.wallet/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
        ...
        case "app.pluswallet":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/app.pluswallet/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/app.pluswallet/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
        ...
        case "com.companyname.swaptobe":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/com.companyname.swaptobe/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/com.companyname.swaptobe/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
        case "com.midoin":
            {
        ...
        case "io.ancrypto":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/io.ancrypto/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/io.ancrypto/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
        ...
        case "finance.slingshot":
            {
                return image ? __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/finance.slingshot/image.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((img)=>img.default) : __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/__generated__/wallet/finance.slingshot/index.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i).then((w)=>w.wallet);
            }
...
async function hasStoredPasskey(client, ecosystemId, storage) {
    const clientStorage = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$in$2d$app$2f$core$2f$authentication$2f$client$2d$scoped$2d$storage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ClientScopedStorage"]({
        storage: storage ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$storage$2f$webStorage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["webLocalStorage"],
        clientId: client.clientId,
...
const getLoginUrl = ({ authOption, client, ecosystem, mode = "popup", redirectUrl })=>{
    ...
    let baseUrl = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebBaseUrl"])("inAppWallet")}/api/2024-05-05/login/${route}?clientId=${client.clientId}`;
...
const getLoginCallbackUrl = ({ authOption, client, ecosystem })=>{
    const route = getLoginOptionRoute(authOption);
    let baseUrl = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebBaseUrl"])("inAppWallet")}/api/2024-05-05/login/${route}/callback?clientId=${client.clientId}`;
    if (ecosystem?.partnerId) {
        baseUrl = `${baseUrl}&ecosystemId=${ecosystem.id}&ecosystemPartnerId=${ecosystem.partnerId}`;
    } else if (ecosystem) {
        baseUrl = `${baseUrl}&ecosystemId=${ecosystem.id}`;
...
const loginWithOauth = async (options)=>{
    ...
    if (!win) {
        win = window.open((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$in$2d$app$2f$core$2f$authentication$2f$getLoginPath$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLoginUrl"])({
            ...options,
            mode: "popup"
        }), `Login to ${options.authOption}`, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$in$2d$app$2f$web$2f$lib$2f$auth$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_POP_UP_SIZE"]);
...
async function connectInAppWallet(options, createOptions, connector) {
    ...
    return {
        account: authAccount,
        chain: options.chain || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$chain$2d$definitions$2f$ethereum$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ethereum"]
    };
}
...
async function handleSwitchChain(options) {
    ...
    if (wallet.getChain()?.id === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["hexToNumber"])(params[0].chainId)) {
        return "0x1";
    }
...
async function createWalletConnectClient(options) {
    ...
    const walletConnectClient = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f40$walletconnect$2f$sign$2d$client$2f$dist$2f$index$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SignClient"].init({
        projectId: options.projectId ?? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$wallet$2d$connect$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_PROJECT_ID"],
        metadata: {
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_wallets_0046b62d._.js.map
...
function parseTypedData(typedData) {
    ...
    if (domain?.chainId !== undefined && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validate"])(domain.chainId)) {
        typedData.domain = {
            ...typedData.domain,
            chainId: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toNumber"])(typedData.domain.chainId)
        };
    }
    return typedData;
...
function encodeParams(preparedParams) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"])(...[
        ...staticParams,
        ...dynamicParams
    ]);
}
...
function encodeArray(value, { length, param }) {
    ...
    if (dynamic || dynamicChild) {
        ...
        if (dynamic) {
            ...
            return {
                dynamic: true,
                encoded: preparedParams.length > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"])(...[
                    length_,
                    data
                ]) : length_
            };
    ...
    return {
        dynamic: false,
        encoded: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"])(...preparedParams.map(({ encoded })=>encoded))
    };
}
function encodeBytes(value, { param }) {
    ...
    if (!paramSize) {
        ...
        return {
            dynamic: true,
            encoded: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"])(...[
...
function encodeTuple(value, { param }) {
    ...
    return {
        dynamic,
        encoded: dynamic ? encodeParams(preparedParams) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["concat"])(...preparedParams.map(({ encoded })=>encoded))
    };
}
...
"[project]/node_modules/thirdweb/dist/esm/chains/chain-definitions/polygon.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/chains/utils.js [app-client] (ecmascript)");
;
const polygon = /*@__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["defineChain"])({
    id: 137,
    name: "Polygon",
    nativeCurrency: {
        name: "POL",
        ...
        try {
            let gas = await eth_estimateGas(rpcRequest, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$formatters$2f$transactionRequest$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatTransactionRequest"])({
                ...
                authorizationList: authorizationList?.map((auth)=>({
                        ...auth,
                        r: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"])(auth.r),
                        s: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Hex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fromNumber"])(auth.s),
...
"[project]/node_modules/thirdweb/dist/esm/transaction/actions/send-batch-transaction.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    if (account.sendBatchTransaction) {
        const serializedTxs = await Promise.all(transactions.map(async (tx)=>{
            ...
            const [data, to, accessList, value] = await Promise.all([
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$promise$2f$resolve$2d$promised$2d$value$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePromisedValue"])(tx.accessList),
...
async function getPastTransactions(options) {
    ...
    const url = new URL(`https://${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().insight}/v1/wallets/${walletAddress}/transactions`);
...
"[project]/node_modules/thirdweb/dist/esm/transaction/actions/send-and-confirm-transaction.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function sendAndConfirmTransaction(options) {
    const submittedTx = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$send$2d$transaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendTransaction"])(options);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$wait$2d$for$2d$tx$2d$receipt$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["waitForReceipt"])(submittedTx);
...
"[project]/node_modules/thirdweb/dist/esm/pay/utils/definitions.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
const getPayBaseUrl = ()=>{
    const payDomain = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getThirdwebDomains"])().pay;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/address.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/fetch.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/pay/utils/definitions.js [app-client] (ecmascript)");
;
;
;
;
...
async function convertCryptoToFiat(options) {
    ...
    if (fromTokenAddress.toLowerCase() !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NATIVE_TOKEN_ADDRESS"].toLowerCase()) {
    ...
    const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayConvertCryptoToFiatEndpoint"])()}?${queryString}`;
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(client)(url);
    if (!response.ok) {
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getStatus.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithCryptoStatus(buyWithCryptoTransaction) {
    try {
        ...
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithCryptoStatusUrl"])()}?${queryString}`;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(buyWithCryptoTransaction.client)(url);
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithFiat/getStatus.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithFiatStatus(params) {
    try {
        ...
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithFiatStatusEndpoint"])()}?${queryString}`;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client)(url);
        if (!response.ok) {
            response.body?.cancel();
            throw new Error(`HTTP error! status: ${response.status}`);
        }
...
"[project]/node_modules/thirdweb/dist/esm/pay/getBuyHistory.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyHistory(params) {
    try {
        ...
        const queryString = queryParams.toString();
        const url = `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyHistoryEndpoint"])()}?${queryString}`;
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client)(url);
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getQuote.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithCryptoQuote(params) {
    try {
        const clientFetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client);
        const response = await clientFetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithCryptoQuoteEndpoint"])(), {
            method: "POST",
            headers: {
        ...
        const swapRoute = {
            transactionRequest: {
                chain: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCachedChain"])(data.transactionRequest.chainId),
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithFiat/getPostOnRampQuote.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getPostOnRampQuote({ client, buyWithFiatStatus }) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$buyWithCrypto$2f$getQuote$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBuyWithCryptoQuote"])({
        client,
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithFiat/getQuote.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithFiatQuote(params) {
    try {
        const clientFetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client);
        const response = await clientFetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithFiatQuoteEndpoint"])(), {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
...
"[project]/node_modules/thirdweb/dist/esm/pay/utils/commonTypes.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithFiat/isSwapRequiredPostOnramp.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function isSwapRequiredPostOnramp(buyWithFiatQuote) {
    ...
    const sameToken = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAddress"])(buyWithFiatQuote.toToken.tokenAddress) === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAddress"])(buyWithFiatQuote.onRampToken.token.tokenAddress);
...
"[project]/node_modules/thirdweb/dist/esm/pay/buyWithCrypto/getTransfer.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function getBuyWithCryptoTransfer(params) {
    try {
        const clientFetch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$fetch$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getClientFetch"])(params.client);
        const response = await clientFetch((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$utils$2f$definitions$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPayBuyWithCryptoTransferEndpoint"])(), {
            method: "POST",
            headers: {
                Accept: "application/json",
                "Content-Type": "application/json"
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_4ca955c1._.js.map
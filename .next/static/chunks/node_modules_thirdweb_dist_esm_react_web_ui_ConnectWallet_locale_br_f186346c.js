...
"[project]/node_modules/thirdweb/dist/esm/react/web/ui/ConnectWallet/locale/br.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const connectWalletLocalPtBr = {
    ...
    guestWalletWarning: "Esta é uma carteira de convidado temporária. Faça um backup se não quiser perder o acesso a ela",
    ...
    receiveFundsScreen: {
        ...
        instruction: "Copie o endereço da carteira para enviar fundos para esta carteira"
    },
    sendFundsScreen: {
        title: "Enviar fundos",
        submitButton: "Enviar",
    ...
    signatureScreen: {
        instructionScreen: {
            title: "Entrar",
            instruction: "Por favor, assine a solicitação de mensagem na sua carteira para continuar",
            signInButton: "Entrar",
            disconnectWallet: "Desconectar carteira"
        },
        signingScreen: {
            ...
            promptForSafe: "Assine a solicitação de assinatura na sua carteira e aprove a transação no Safe",
...
const __TURBOPACK__default__export__ = connectWalletLocalPtBr;
 //# sourceMappingURL=br.js.map
}}),
}]);

//# sourceMappingURL=node_modules_thirdweb_dist_esm_react_web_ui_ConnectWallet_locale_br_f186346c.js.map
...
"[project]/node_modules/thirdweb/dist/esm/rpc/actions/eth_getStorageAt.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function eth_getStorageAt(request, params) {
    return await request({
        ...
        params: [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAddress"])(params.address),
            params.position,
...
"[project]/node_modules/thirdweb/dist/esm/utils/bytecode/extractMinimalProxyImplementationAddress.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/utils/bytecode/resolveImplementation.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$actions$2f$eth_getStorageAt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/rpc/actions/eth_getStorageAt.js [app-ssr] (ecmascript)");
...
contract) {
    const [originalBytecode, beacon] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$contract$2f$actions$2f$get$2d$bytecode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBytecode"])(contract),
        getBeaconFromStorageSlot(contract)
    ]);
    // check minimal proxy first synchronously
    const minimalProxyImplementationAddress = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$bytecode$2f$extractMinimalProxyImplementationAddress$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extractMinimalProxyImplementationAddress"])(originalBytecode);
    ...
    if (implementationAddress && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAddress"])(implementationAddress) && implementationAddress !== AddressZero) {
        const implementationBytecode = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$contract$2f$actions$2f$get$2d$bytecode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getBytecode"])({
            ...contract,
...
contract) {
    ...
    try {
        const proxyStorage = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$actions$2f$eth_getStorageAt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eth_getStorageAt"])(rpcRequest, {
            address: contract.address,
...
contract) {
    ...
    try {
        const proxyStoragePromises = [
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$rpc$2f$actions$2f$eth_getStorageAt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["eth_getStorageAt"])(rpcRequest, {
                address: contract.address,
...
contract) {
    try {
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$read$2d$contract$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["readContract"])({
            contract,
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_3806d5c1._.js.map
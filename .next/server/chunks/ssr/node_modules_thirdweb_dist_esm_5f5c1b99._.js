...
"[project]/node_modules/thirdweb/dist/esm/utils/contract/fetchContractMetadata.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "fetchContractMetadata": (()=>fetchContractMetadata)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$base64$2f$base64$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/base64/base64.js [app-ssr] (ecmascript)");
;
async function fetchContractMetadata(options) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$base64$2f$base64$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isBase64JSON"])(uri)) {
        try {
            return JSON.parse((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$base64$2f$base64$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseBase64String"])(uri));
        } catch (e) {
...
"[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/get-claim-params.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getClaimParams": (()=>getClaimParams)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$extensions$2f$common$2f$read$2f$getContractMetadata$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/extensions/common/read/getContractMetadata.js [app-ssr] (ecmascript) <locals>");
;
;
;
async function getClaimParams(options) {
    const cc = await (async ()=>{
        if (options.type === "erc1155") {
            ...
            const { getActiveClaimCondition } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/extensions/erc1155/drops/read/getActiveClaimCondition.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        ...
        if (options.type === "erc721") {
            ...
            if (options.singlePhaseDrop) {
                const { claimCondition } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/extensions/erc721/__generated__/IDropSinglePhase/read/claimCondition.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
                return await claimCondition({
                    contract: options.contract
                });
            }
            const { getActiveClaimCondition } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/extensions/erc721/drops/read/getActiveClaimCondition.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
            return await getActiveClaimCondition({
                contract: options.contract
            });
        }
        ...
        const { getActiveClaimCondition } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/extensions/erc20/drops/read/getActiveClaimCondition.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        return await getActiveClaimCondition({
            contract: options.contract
        });
    })();
    ...
    const allowlistProof = await (async ()=>{
        ...
        if (!cc.merkleRoot || cc.merkleRoot === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$data$2f$pad$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["padHex"])("0x", {
            size: 32
        })) {
            return {
                currency: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"],
                proof: [],
                quantityLimitPerWallet: 0n,
                pricePerToken: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$constants$2f$number$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maxUint256"]
            };
        }
        // lazy-load the fetchProofsForClaimer function if we need it
        const { fetchProofsForClaimer } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/fetch-proofs-for-claimers.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        // 1. fetch merkle data from contract URI
        const metadata = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$extensions$2f$common$2f$read$2f$getContractMetadata$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getContractMetadata"])({
            contract: options.contract
        });
    ...
    const currency = allowlistProof.currency && allowlistProof.currency !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"] ? allowlistProof.currency : cc.currency;
    const pricePerToken = allowlistProof.pricePerToken !== undefined && allowlistProof.pricePerToken !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$constants$2f$number$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maxUint256"] ? allowlistProof.pricePerToken : cc.pricePerToken;
    const totalPrice = pricePerToken * options.quantity / BigInt(10 ** tokenDecimals);
    const value = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNativeTokenAddress"])(currency) ? totalPrice : 0n;
    const erc20Value = !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNativeTokenAddress"])(currency) && pricePerToken > 0n ? {
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_5f5c1b99._.js.map
...
"[project]/node_modules/thirdweb/dist/esm/storage/upload/helpers.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ function isBufferOrStringWithName(data) {
    ...
    return !!(typeof data.name === "string" && (typeof data.data === "string" || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(data.data)));
}
function isFileBufferOrStringEqual(input1, input2) {
    if (isFileInstance(input1) && isFileInstance(input2)) {
    ...
    } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(input1) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(input2)) {
        // buffer gives us an easy way to compare the contents!
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["areUint8ArraysEqual"])(input1, input2);
        ...
        if (input1.name === input2.name) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(input1.data) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(input2.data)) {
                // otherwise we know it's buffers, so compare the buffers
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["areUint8ArraysEqual"])(input1.data, input2.data);
            }
        }
    }
...
function isFileOrUint8Array(data) {
    return isFileInstance(data) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isUint8Array"])(data) || isBufferOrStringWithName(data);
}
...
"[project]/node_modules/thirdweb/dist/esm/storage/upload.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/storage/upload/helpers.js [app-ssr] (ecmascript)");
;
;
;
async function upload(options) {
    ...
    // handle file arrays
    const isFileArray = options.files.map((item)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isFileOrUint8Array"])(item) || typeof item === "string").every((item)=>!!item);
    let uris;
    if (isFileArray) {
        ...
        cleaned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["replaceObjectGatewayUrlsWithSchemes"])(cleaned);
        // Recurse through data and extract files to upload
        const files = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["extractObjectFiles"])(cleaned);
        if (files.length) {
            ...
            cleaned = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["replaceObjectFilesWithUris"])(cleaned, // always pass an array even if the underlying upload returns a single uri
        ...
        uris = cleaned.map((item)=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stringify"])(item);
        });
    }
    // end deal with the differnt file types
    const form_ = new FormData();
    const { fileNames, form } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$upload$2f$helpers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildFormData"])(form_, uris, options);
    const platform = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$detect$2d$platform$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["detectPlatform"])();
    if (platform === "browser" || platform === "node") {
        const { uploadBatch } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/storage/upload/web-node.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_132e69c0._.js.map
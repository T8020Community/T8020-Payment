...
"[project]/node_modules/thirdweb/dist/esm/merkletree/MerkleTree.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class MerkleTree {
    constructor(leaves){
        ...
        this.leaves = leaves.map((el)=>el instanceof Uint8Array ? el : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$to$2d$bytes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexToBytes"])(el));
        this.leaves = this.leaves.sort(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compareUint8Arrays"]);
        this.createHashes(this.leaves);
    }
    getHexRoot() {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["uint8ArrayToHex"])(this.getRoot());
    }
    getHexProof(leaf, index) {
        return this.getProof(leaf, index).map((item)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$hex$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["uint8ArrayToHex"])(item.data));
    }
    // private below
    createHashes(nodes) {
        this.layers = [
        ...
        while(nodes.length > 1){
            ...
            for(let i = 0; i < nodes.length; i += 2){
                ...
                combined.sort(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["compareUint8Arrays"]);
                const hash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$hashing$2f$keccak256$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["keccak256"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["concatUint8Arrays"])(combined), "bytes");
                // biome-ignore lint/style/noNonNullAssertion: in bounds
    ...
    getProof(leaf, index) {
        ...
        // biome-ignore lint/style/noParameterAssign: part of the functionality
        leaf = leaf instanceof Uint8Array ? leaf : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$encoding$2f$to$2d$bytes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexToBytes"])(leaf);
        const proof = [];
        if (!Number.isInteger(index)) {
            ...
            for(let i = 0; i < this.leaves.length; i++){
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$uint8$2d$array$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["areUint8ArraysEqual"])(leaf, this.leaves[i])) {
                    // biome-ignore lint/style/noParameterAssign: part of the functionality
                    index = i;
                }
            }
...
"[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/convert-quantity.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function convertQuantity(options) {
    ...
    if (quantity === "unlimited") {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Solidity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maxUint256"];
    }
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUnits"])(quantity, tokenDecimals);
...
function encode(type, value, isArray = false) {
    ...
    if (bytesMatch) {
        ...
        if (Number.parseInt(size) !== (value.length - 2) / 2) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$errors$2f$abi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BytesSizeMismatchError"]({
...
"[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/hash-entry.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$encodePacked$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/node_modules/viem/_esm/utils/abi/encodePacked.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$hashing$2f$keccak256$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/hashing/keccak256.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$convert$2d$quantity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/convert-quantity.js [app-ssr] (ecmascript)");
;
;
;
;
...
async function hashEntry(options) {
    const currencyAddress = options.entry.currencyAddress || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"];
    const currencyDecimals = await (async ()=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNativeTokenAddress"])(currencyAddress) || currencyAddress === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"]) {
            return 18;
        }
        const [{ getContract }, { decimals: getDecimals }] = await Promise.all([
            __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/contract/contract.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i),
            __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/extensions/erc20/read/decimals.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i)
        ]);
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$hashing$2f$keccak256$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["keccak256"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$abi$2f$encodePacked$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encodePacked"])([
        "address",
        "uint256",
        "uint256",
        "address"
    ], [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAddress"])(options.entry.address),
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$convert$2d$quantity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertQuantity"])({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$address$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAddress"])(currencyAddress)
    ]));
} //# sourceMappingURL=hash-entry.js.map
}}),
"[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/fetch-proofs-for-claimers.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/constants/addresses.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$merkletree$2f$MerkleTree$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/merkletree/MerkleTree.js [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$convert$2d$quantity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/convert-quantity.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$hash$2d$entry$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/utils/extensions/drops/hash-entry.js [app-ssr] (ecmascript)");
;
;
;
;
...
async function fetchProofsForClaimer(options) {
    ...
    const hashEntryFn = options.hashEntry || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$hash$2d$entry$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hashEntry"];
    // 2. download snapshot data
    const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$download$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["download"])({
    ...
    try {
        ...
        const shard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$storage$2f$download$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["download"])({
            client: contract.client,
    ...
    const tree = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$merkletree$2f$MerkleTree$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MerkleTree"](hashedEntries);
    ...
    const currencyAddress = entry.currencyAddress || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"];
    const currencyDecimals = await (async ()=>{
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isNativeTokenAddress"])(currencyAddress) || currencyAddress === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ZERO_ADDRESS"]) {
            return 18;
        }
    ...
    return {
        proof,
        quantityLimitPerWallet: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$convert$2d$quantity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertQuantity"])({
            quantity: entry.maxClaimable || "unlimited",
            tokenDecimals: options.tokenDecimals
        }),
        pricePerToken: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$extensions$2f$drops$2f$convert$2d$quantity$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertQuantity"])({
...
//# sourceMappingURL=node_modules_thirdweb_aecb0988._.js.map
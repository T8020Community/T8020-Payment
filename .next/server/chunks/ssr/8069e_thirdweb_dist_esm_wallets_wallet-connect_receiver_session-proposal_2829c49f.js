...
"[project]/node_modules/thirdweb/dist/esm/wallets/wallet-connect/receiver/session-proposal.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function onSessionProposal(options) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$wallet$2d$connect$2f$receiver$2f$session$2d$store$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveSession"])(session);
    wallet.subscribe("disconnect", ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$wallet$2d$connect$2f$receiver$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["disconnectWalletConnectSession"])({
            session,
            walletConnectClient
        });
    });
...
async function disconnectExistingSessions({ walletConnectClient, origin }) {
    const sessions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$wallet$2d$connect$2f$receiver$2f$session$2d$store$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getSessions"])();
    for (const session of sessions){
        if (session.origin === origin) {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$wallet$2d$connect$2f$receiver$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["disconnectWalletConnectSession"])({
                session,
                walletConnectClient
            });
        }
...
//# sourceMappingURL=8069e_thirdweb_dist_esm_wallets_wallet-connect_receiver_session-proposal_2829c49f.js.map